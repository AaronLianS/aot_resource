...
管理员可解散群
curl "http://node1.simba.pro:8015/uic-server-group/uic/group/dissolveGroup?groupNumber=12345&userNumber=123456"



#---------------------
select name,group_number,user_number from uic_group_info where create_time <= unix_timestamp('20170801') and user_number=66925079 and group_type=0 ;