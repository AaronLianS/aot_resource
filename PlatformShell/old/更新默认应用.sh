...
curl -H "Content-Type:application/json" -X POST --data '{"enterpriseId":"700085","appCodes":["Basica0ezz4yk69gwzhekfc7C7c","Basica0ezsrfn1ypsoqpcb8R549","Basica0f142rgw5wgh9fe23wN67"]}' "http://10.0.0.11:8015/operation-server-basic/operation/basicApp/setEnterCustom"
...
#--编辑应用------
curl -H "Content-Type:application/json" -X POST --data '{
"appCode": "Basica0ezsrfn1ypsoqpcb8R549",
...
# curl -d "appCode=Basica0f41xy7qs34e8sv286e83" "http://10.0.0.11:8015/operation-server-basic/operation/basicApp/setEnable"