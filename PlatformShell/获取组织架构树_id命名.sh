...
echo "$deptId,$deptId;">>deptFullPath.txt
...
if [ "$leavel4" != "null" ];then
 ...
 do
  ...
  echo "$deptId5,$deptId-$deptId2-$deptId3-$deptId4-$deptId5;">>deptFullPath.txt
...
#-------------------------【5】--------------------
  ...
  echo "$deptId4,$deptId-$deptId2-$deptId3-$deptId4;">>deptFullPath.txt
...
#-------------------------【4】--------------------
  ...
  echo "$deptId3,$deptId-$deptId2-$deptId3;">>deptFullPath.txt
...
#-------------------------【3】--------------------
  ...
  echo "$deptId2,$deptId-$deptId2;">>deptFullPath.txt
